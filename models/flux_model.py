...
from config.settings import (
    FLUX_MODEL_ID, NUNCHAKU_MODEL_ID, FP4_WEIGHTS_FILE, INT4_WEIGHTS_FILE,
    MODEL_TYPE_STANDARD_CPU, MODEL_TYPE_STANDARD_GPU, MODEL_TYPE_QUANTIZED_GPU,
    DEFAULT_DEVICE_MAP, DEFAULT_TORCH_DTYPE_CPU, DEFAULT_TORCH_DTYPE_GPU,
    LOW_CPU_MEMORY_USAGE, HUGGINGFACE_CACHE_DIR
)
    ...
    def _integrate_quantized_weights(self, device: str) -> bool:
        ...
        try:
            ...
            quantized_dir = snapshot_download(
                NUNCHAKU_MODEL_ID,
                cache_dir=os.path.expanduser(HUGGINGFACE_CACHE_DIR)
            )
