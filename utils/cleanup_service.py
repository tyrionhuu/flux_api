...
from config.cleanup_settings import (
    CLEANUP_ENABLED, CLEANUP_INTERVAL_SECONDS, 
    CLEANUP_ON_UPLOAD, CLEANUP_ON_GENERATION,
    MIN_FILE_AGE_HOURS, PRIORITY_FILE_EXTENSIONS
)
...
class CleanupService:
    ...
    def _perform_cleanup(self, trigger: str):
        ...
        try:
            ...
            logger.info(f"Cleanup completed in {cleanup_time:.2f}s (trigger: {trigger}): {results}")
