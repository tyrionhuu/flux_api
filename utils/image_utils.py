...
def extract_image_from_result(result: Any) -> Image.Image:
    ...
    try:
        ...
        return Image.new("RGB", DEFAULT_IMAGE_SIZE, color=PLACEHOLDER_COLORS["placeholder"])
...
def save_image_with_unique_name(image: Image.Image, directory: str = "generated_images") -> str:
