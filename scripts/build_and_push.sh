...
# Configuration
REPO_NAME="eigenai/kontext-clean-0924"
VERSION=$(date +%Y%m%d-%H%M%S)
TAG="${REPO_NAME}:v${VERSION}"
...
echo "   docker run -d --name kontext-api --gpus all -p 9300:9300 $LATEST_TAG"
echo ""
echo "🔧 With LoRA fusion:"
echo "   docker run -d --name kontext-api-with-lora --gpus all -p 9300:9300 \\"
echo "     $LATEST_TAG \\"
echo "     --lora-name \"my-lora.safetensors\" \\"
echo "     --lora-weight 1.2 \\"
echo "     --fusion-mode"
echo ""
echo "🏥 Health check:"
